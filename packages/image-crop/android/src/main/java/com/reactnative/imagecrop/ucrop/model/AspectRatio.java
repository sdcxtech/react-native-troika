package com.reactnative.imagecrop.ucrop.model;
...
public class AspectRatio implements Parcelable {
    ...
    public static final Creator<com.reactnative.imagecrop.ucrop.model.AspectRatio> CREATOR = new Creator<com.reactnative.imagecrop.ucrop.model.AspectRatio>() {
        @Override
        public com.reactnative.imagecrop.ucrop.model.AspectRatio createFromParcel(Parcel in) {
            return new com.reactnative.imagecrop.ucrop.model.AspectRatio(in);
        }

        @Override
        public com.reactnative.imagecrop.ucrop.model.AspectRatio[] newArray(int size) {
            return new com.reactnative.imagecrop.ucrop.model.AspectRatio[size];
        }
    };
