...
public class RotationGestureDetector {
    ...
    public static class SimpleOnRotationGestureListener implements OnRotationGestureListener {
        ...
        @Override
        public boolean onRotation(com.reactnative.imagecrop.ucrop.util.RotationGestureDetector rotationDetector) {
            return false;
        }
    }
    ...
    public interface OnRotationGestureListener {
        ...
        boolean onRotation(com.reactnative.imagecrop.ucrop.util.RotationGestureDetector rotationDetector);
    }
