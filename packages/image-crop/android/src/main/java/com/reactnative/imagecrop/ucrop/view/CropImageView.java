package com.reactnative.imagecrop.ucrop.view;
...
import com.reactnative.imagecrop.R;
import com.reactnative.imagecrop.ucrop.callback.BitmapCropCallback;
import com.reactnative.imagecrop.ucrop.callback.CropBoundsChangeListener;
import com.reactnative.imagecrop.ucrop.model.CropParameters;
import com.reactnative.imagecrop.ucrop.model.ImageState;
import com.reactnative.imagecrop.ucrop.task.BitmapCropTask;
import com.reactnative.imagecrop.ucrop.util.CubicEasing;
import com.reactnative.imagecrop.ucrop.util.RectUtils;
import com.reactnative.imagecrop.ucrop.view.TransformImageView;
...
public class CropImageView extends TransformImageView {
        ...
        if (mBitmapLaidOut && !isImageWrapCropBounds()) {
            ...
            if (animate) {
                post(mWrapCropBoundsRunnable = new WrapCropBoundsRunnable(
                        com.reactnative.imagecrop.ucrop.view.CropImageView.this, mImageToWrapCropBoundsAnimDuration, currentX, currentY, deltaX, deltaY,
    ...
    protected void zoomImageToPosition(float scale, float centerX, float centerY, long durationMs) {
        ...
        post(mZoomImageToPositionRunnable = new ZoomImageToPosition(com.reactnative.imagecrop.ucrop.view.CropImageView.this,
    ...
    private static class WrapCropBoundsRunnable implements Runnable {
        ...
        private final WeakReference<com.reactnative.imagecrop.ucrop.view.CropImageView> mCropImageView;
        ...
        public WrapCropBoundsRunnable(com.reactnative.imagecrop.ucrop.view.CropImageView cropImageView,
                                      long durationMs,
        ...
        @Override
        public void run() {
            com.reactnative.imagecrop.ucrop.view.CropImageView cropImageView = mCropImageView.get();
    ...
    private static class ZoomImageToPosition implements Runnable {
        ...
        public ZoomImageToPosition(com.reactnative.imagecrop.ucrop.view.CropImageView cropImageView,
                                   long durationMs,
                                   float oldScale, float deltaScale,
